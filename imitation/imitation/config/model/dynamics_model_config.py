...
from imitation.algo.dynamics_model import ReconstructionDynamicsModel, ReconstructionInverseDynamicsModel
...
policy_config = AttrDict(
    policy_class=ReconstructionInverseDynamicsModel,
    latent_dim=256,
